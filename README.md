...
For a full list of annotations and their meanings see the top of the file [xsdForms.scala](https://github.com/davidmoten/xsd-forms/blob/master/xsd-forms-generator/src/main/scala/com/github/davidmoten/xsdforms/xsdForms.scala).
